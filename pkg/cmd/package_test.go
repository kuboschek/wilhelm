...
func TestPackage(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			args:   []string{},
			flags:  map[string]string{},
			expect: "bruke mindestens een Argument, den Pfad to de Chart",
			err:    true,
		},
		{
			...
			expect: "--key es erforderlich för dat Signeren von eene Packäschen",
			err:    true,
		},
		{
			...
			expect: "--keyring es erforderlich för dat Signeren von eene Packäschen",
			err:    true,
		},
		{
